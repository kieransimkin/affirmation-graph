...
const ownerStakeKey = lucid.utils.getAddressDetails(
  await ownerWallet.address(),
).stakeCredential;
...
const datum = Data.to(new Constr(0, [new Constr(0, [ownerStakeKeyHash])]));
...
let tx = await lucid
  ...
  .mintAssets(
    { [policyID + ownerStakeKeyHash]: BigInt(1) },
